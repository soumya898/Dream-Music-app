...
// const RightSidebar = () => {
//     const { currentTrack, playTrack, pauseTrack, nextTrack, previousTrack, isPlaying } = useContext(MusicContext); // Access the context
//     const [isDragging, setIsDragging] = useState(false);
//     const [position, setPosition] = useState({ x: 100, y: 100 }); // Initial position of the card
//     const cardRef = useRef(null); // Ref for the draggable card

//     // Handle dragging functionality
//     const handleMouseDown = (e) => {
//         setIsDragging(true);
//         cardRef.current.style.cursor = 'grabbing'; // Change cursor style
//     };
...
//     const handleMouseUp = () => {
//         setIsDragging(false);
//         cardRef.current.style.cursor = 'grab'; // Reset cursor style
//     };

//     // Play/Pause functionality
//     const handlePlayPause = () => {
//         if (isPlaying) {
//             pauseTrack(); // Pause the track immediately
//         } else {
...
//             >
//                 {/* Display the Controls with the currentTrack */}
//                 {currentTrack ? (
//                     <div>
